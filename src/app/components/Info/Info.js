...
export default function Info() {
  return (
    <div className=' h-dvh w-dvw bg-bg-1 text-primary lg:flex lg:flex-col justify-center items-center'>
        <div className='pt-20 pr-10 pl-10 lg:pt-0 lg:pl-40 lg:pb-0 lg:pr-20 flex flex-col lg:flex-row justify-between gap-20 w-full'>
          ...
          once: true, // true = animate only once
                                            ...
                                            className={`w-dvw md:text-[1.5rem] text-left lg:text-[3.5rem] font-head font-extrabold leading-none`}>Introduction to <br /> Stellar Mulberry</motion.h1>
                <section className='w-dvw lg:w-full flex font-subHead text-md justify-between lg:mt-20 gap-50'>
         ...
         className='w-fit text-wrap leading-tight mt-30 text-justify'>At Stellar Homes, we believe a home should be more than just walls—it should be a legacy. Stellar Mulberry is a premium plotted development in Chikkaballapur designed to offer a wholesome lifestyle away from city chaos. Whether you are building a weekend retreat or securing a future asset, this is your gateway to peaceful living and smart investment.</motion.p>
                    ...
                    <ul className='list-disc leading-tight flex lg:flex-col lg:w-[40%] gap-30 lg:gap-10'>
          ...
          once: true, // true = animate only once
                        ...
                        className=''> Designed to bring nature to your doorstep with abundant tropical green patches, tree-lined paths, and landscaped open spaces that offer a breath of fresh air.</motion.li>
                        <motion.li initial={{ transform: "translateY(50px)", opacity: 0, filter: "blur(2px)"}}
                        whileInView={{ opacity: 1, transform: "translateY(0px)", filter: "blur(0)" }} 
                        transition={{duration: 1,
                                            delay: 0.4,
          ...
          once: true, // true = animate only once
                         ...
                         className=''> A future-ready asset with DTCP & RERA approvals and high appreciation potential, located in a rapidly growing region with easy bank loan options up to 90%.</motion.li>
                        <motion.li initial={{ transform: "translateY(50px)", opacity: 0, filter: "blur(2px)"}}
                        whileInView={{ opacity: 1, transform: "translateY(0px)", filter: "blur(0)" }} 
                        transition={{duration: 1,
                                            delay: 0.6,
          ...
          once: true, // true = animate only once
                         ...
                         className=''> Strategically located near Nandi Hills and the Isha Foundation, offering excellent connectivity to Bengaluru via highways while remaining a serene spiritual and tourism hub.</motion.li>
                    </ul>
                </section>

            </div>
            <div className='pb-40 lg:p-0 w-[35%] '>
          ...
          once: true, // true = animate only once
                 ...
                 className='bg-gray-300 h-full w-full md:h-full rounded-2xl hover:shadow-md transition-all duration-500 ease-in-out'></motion.div>
            </div>
        </div>
    </div>
