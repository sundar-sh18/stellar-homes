...
const data = [
  ...
  return (
    <div className='min-h-dvh bg-primary flex flex-col justify-between gap-10 lg:gap-20 w-full py-20 lg:py-0'>
      ...
      <div className='bg-primary flex flex-col lg:flex-row mt-10 lg:mt-60 mx-6 lg:mx-40 mb-0 gap-10'>
        ...
        <div className='w-full lg:w-full lg:h-auto transition-all duration-200 ease-[cubic-bezier(0.075, 0.82, 0.165, 1)] hover:scale-95'>
            <motion.div 
            ...
            >
                <div className={`${style.rotate} bg-bg-1 rounded-4xl w-fit h-fit p-2 absolute transition-all duration-200 ease-[cubic-bezier(0.075, 0.82, 0.165, 1)] top-5 lg:top-10 rotate`}><MoveRight/></div>
                <div className='bg-bg-1 text-center font-body text-2xl lg:text-4xl m-5 lg:m-10 absolute bottom-0 px-10 py-2 rounded-md shadow-md'>
                    Green, Gated, & Serene
                </div>
            </motion.div>
        </div>
